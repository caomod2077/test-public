...
local Window = WindUI:CreateWindow({  
    Title = "Foxname - 99 Night in the forest | v1.0.5",  
    Author = "Dev:Cáo Mod",  
    Theme = "MonokaiPro",  
...
local WeaponKeywords = {"axe", "katana", "Chainsaw", "Cultist King Mace", "Infernal Sword", "Spear"}
...
getgenv().TypeSelect = {      
    ...
    ["Other"] = {"Sacrifice Totem","Rabbit Foot","Wolf Pelt","Alpha Wolf Pelt","Bear Pelt","Wolf Corpse","Alpha Wolf Corpse","Bear Corpse"}      
}    
...
MisTab:Toggle({
    ...
    Callback = function(state)
        ...
        task.spawn(function()
            ...
            -- giữ vị trí gốc để tránh rollback
            local holdTime = 3
            local t0 = tick()
...
MisTab:Toggle({
    ...
    Callback = function(state)
        ...
        if state then
            -- ưu tiên disable mấy connection mặc định
            ...
            -- luôn gắn thêm fake input phòng trường hợp disable fail
